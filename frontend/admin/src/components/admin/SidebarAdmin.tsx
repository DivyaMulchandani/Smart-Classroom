...
const links = [
  { href: '/admin/attendance', label: 'Attendance Management', icon: CheckSquare },
  { href: '/admin/results', label: 'Results Management', icon: GraduationCap },
  { href: '/admin/courses', label: 'Courses', icon: ClipboardList },
  { href: '/admin/schedule', label: 'Schedule', icon: Calendar },
  { href: '/admin/documents', label: 'Academic Documents', icon: FileText },
  { href: '/admin/appointments', label: 'Counselling & Appointments', icon: Users }
]
